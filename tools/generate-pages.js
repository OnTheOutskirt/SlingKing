    ...
    <div class="container">
      ...
      <div class="footer-bottom">
        <div class="footer-bottom-meta">
          <p>&copy; 2026 TKO Inc. / 4D Innovations. All rights reserved. Katy, TX.</p>
...
${shopAddForm('launcher', 'Water Balloon Launcher™', '29.95', 'assets/product-launcher.webp')}
            </div>
          </article>
          <article class="product-card">
...
${shopAddForm('beast', 'Beast™ Mega Slingshot™', '39.95', 'assets/product-beast-mega-launcher.webp')}
            </div>
          </article>
        </div>
      </div>
...
${shopAccessoryCard({
  ...
  'launcher.html': productPage({
    ...
    description: 'The original Slingking Water Balloon Launcher™. Complete kit with patented Fill Anywhere™ system. Up to 100 yards. $29.95.',
    label: 'The Original',
  ...
  'beast.html': productPage({
    ...
    description: 'Slingking Beast™ Mega Slingshot™ — triple-barrel mountable mega launcher. Up to 300 yards. $39.95.',
    label: 'Flagship',
