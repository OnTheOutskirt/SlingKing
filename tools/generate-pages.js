...
${shopAddForm('launcher', 'Water Balloon Launcher™', '24.95', 'assets/product-launcher.webp')}
            </div>
          </article>
          <article class="product-card">
...
${shopAddForm('beast', 'Beast™ Mega Slingshot™', '54.95', 'assets/product-beast-mega-launcher.webp')}
            </div>
          </article>
        </div>
      </div>
...
${shopAccessoryCard({
  ...
  'launcher.html': productPage({
    ...
    description: 'The original Slingking Water Balloon Launcher™. Complete kit with patented Fill Anywhere™ system. Up to 100 yards. $24.95.',
    label: 'The Original',
  ...
  'beast.html': productPage({
    ...
    description: 'Slingking Beast™ Mega Slingshot™ — triple-barrel mountable mega launcher. Up to 300 yards. $54.95.',
    label: 'Flagship',
